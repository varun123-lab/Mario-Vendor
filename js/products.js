...
let products = [
    ...
    },
    {
        ...
        description: 'Iconic spider web print design. Heavy-weight fleece construction with bold graphics.',
        sizes: ['S', 'M', 'L', 'XL'],
    ...
    // Sweaters
    {
        ...
        description: 'Classic cable-knit sweater. 100% merino wool construction with embroidered pony logo.',
        sizes: ['S', 'M', 'L', 'XL'],
    ...
    },
    {
        ...
        description: 'Fear of God Essentials relaxed fit crewneck sweater. Soft cotton blend fabric with rubberized branding.',
        sizes: ['XS', 'S', 'M', 'L', 'XL'],
        colors: ['Tan', 'Black', 'Dark Oatmeal'],
        stock: 22,
        badge: 'new',
        featured: true
    },
